<?php
    ...
    if (!$conn->connect_error) {
        try {
            $conn->query(query: "CREATE DATABASE IF NOT EXISTS Alumni"); // DB creation
            $conn->select_db(database: "Alumni"); // DB selection
        } catch (Exception $e) {
        ...
        try{
            ...
            $conn->query(query: "CREATE TABLE IF NOT EXISTS advertisement_table (
            ...
            $conn->query(query: "CREATE TABLE IF NOT EXISTS advertisement_registration_table (
