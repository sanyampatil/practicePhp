...
<body>
    ...
    <nav class="navbar sticky-top navbar-expand-lg mb-5">
        <div class="container">
            <a class="navbar-brand mx-0 mb-0 h1" href="main_menu.php">Alumni Portal of KDK college</a>
    ...
    <div class="container slide-left">
        ...
        <!-- College Image -->
                    <?php
            $image_path = "https://www.kdkce.edu.in/writereaddata/banner/1633592543_BANNER.jpg"; // Change the path as needed
            ?>
            ...
            <body>
                ...
                <div class="image-container">
                    <img src="https://www.kdkce.edu.in/writereaddata/banner/1633592543_BANNER.jpg" alt="College Image">
                </div>

                <div class="content">
                    <h3>Welcome to KDK College Alumni Portal</h3>
                    <p>An alumni section in your student alumni portal serves as a bridge between past and present students, allowing alumni to stay connected with their college and network with fellow graduates..</p>
                    <p>Here is some information about Alumnis,Evens,News.</p>
                </div>
...
<footer>
<p>Copyright &#169; 2025 KDKCE . All Rights Reserved.</p>
</footer>
</body>
</html>