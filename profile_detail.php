                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <?php
                                ...
                                echo (isset($alumnusToViewDegreeYearGraduated) && $alumnusToViewDegreeYearGraduated != '') ? '<p class="my-0" style="margin-left: 1px;" class="ms-3fw-light text-secondary">Graduated in '.$alumnusToViewDegreeYearGraduated.'</p>' : '';
