...
<?php
    ...
    $SQLGetAccountInfo = $conn->prepare(query: "SELECT email, type, status FROM account_table WHERE email = ?");
    ...
    $SQLGetUserInfo = $conn->prepare(query: "SELECT * FROM user_table WHERE email = ?");
