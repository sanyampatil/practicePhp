            ...
            <div class="container py-4 px-4 mb-5 mainView bg-white ">
                <div class="row slide-left">
                    <div class="col-auto mx-3">
                        ...
                        <!-- create resume -->
                        <form class="col-9 mt-5">
                            <legend class="h4">Create Resume</legend>
                            <a class="w-100 btn btn-primary fw-medium ms-4" href="myresumes.php" id="CreateResumeButton"><i class="bi bi-plus-lg me-2"></i>Create Resume</a>
                        </form>
